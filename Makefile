...
# changelog:
# 	${JULIA} -e 'using Changelog; Changelog.generate(Changelog.CommonMark(), "CHANGELOG.md"; repo = "oameye/KeldyshContraction.jl")'
...
.PHONY: default setup format changelog test docs all help